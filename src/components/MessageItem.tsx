...
export default ({ role, message, showRetry, onRetry }: Props) => {
  ...
  const msg = typeof message === 'string' ? (message as string).indexOf(`我的问题是：`) !== -1 ? (message as string).substring((message as string).indexOf(`我的问题是：`) + 6) : message : message
  ...
  const htmlString = () => {
    ...
    if (typeof message === 'function')
      ...
      return md.render(msg as string)
